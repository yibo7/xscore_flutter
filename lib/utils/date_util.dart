...
class DateUtil {
  ...
  static String getTimeName(String dt){
    var _strtimes = DateTime.parse(dt);
    var t = DateTime.now();
    // print(t); //当前时间戳
    // var s = DateTime.fromMillisecondsSinceEpoch(_strtimes.millisecondsSinceEpoch);
    // print(s); //时间戳转时间 2021-05-29 11:48:06.181

    var timeLag = t.difference(_strtimes); //时间戳进行比较
    // print("时间差：${timeLag}");
